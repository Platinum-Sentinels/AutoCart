...
export default function SearchHistoryPage() {
  ...
  useEffect(() => {
    setSearchHistory([
      { id: '1', query: 'Wireless headphones', date: '2023-06-01', results: 15 },
      { id: '2', query: 'Smartphone under $500', date: '2023-05-28', results: 23 },
      { id: '3', query: 'Best laptop for programming', date: '2023-05-25', results: 18 },
    ])
  }, [])
